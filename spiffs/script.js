...
window.addEventListener("load", async ()=>{
  ...
  const collect = await LoadSettings(); // from globalData.js stub

  
  console.log(`From script: ${userPrefs.user_name}`);
  console.log(`From script: ${userPrefs.device_name}`);
  console.log(`From script: ${systemSettings.first_boot}`);
...
function goToDashboard() {
    const lang = (systemSettings && systemSettings.device_lang) ? systemSettings.device_lang : "en";
